...
export const Header = () => {
  return (
    <header className="header bg-primary flex items-center justify-between p-4 bg-primary">
      <div className="header__left flex items-center">
        <img
          src={GCLogo}
          alt="logo"
          className="header__logo object-contain w-2/12 mx-2"
        />
        <h1 className="header__title text-4xl font-bold mx-2">
